...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.en = {
		...
		language   : 'English',
		direction  : 'ltr',
		dateFormat : 'M d, Y h:i A', // Mar 13, 2013 05:27 PM
		...
		messages   : {
			...
			'errArcSymlinks'       : 'For security reason denied to unpack archives contains symlinks or files with not allowed names.', // edited 24.06.2013
			'errArcMaxSize'        : 'Archive files exceeds maximum allowed size.',
			'errResize'            : 'Unable to resize "$1".',
			'errUsupportType'      : 'Unsupported file type.',
			'errNotUTF8Content'    : 'File "$1" is not in UTF-8 and cannot be edited.',  // added 9.11.2011
			'errNetMount'          : 'Unable to mount "$1".', // added 17.04.2013
			'errNetMountNoDriver'  : 'Unsupported protocol.',     // added 17.04.2013
			'errNetMountFailed'    : 'Mount failed.',         // added 17.04.2013
			'errNetMountHostReq'   : 'Host required.', // added 18.04.2013
			/******************************* commands names ********************************/
			...
			'cmdsort'      : 'Sort',
			'cmdnetmount'  : 'Mount network volume', // added 18.04.2013
			...
			'btnNo'     : 'No',
			'btnYes'    : 'Yes',
			'btnMount'  : 'Mount',  // added 18.04.2013
			/******************************** notifications ********************************/
			'ntfopen'     : 'Open folder',
			'ntffile'     : 'Open file',
			...
			'ntfsmth'     : 'Doing something >_<',
      		...
      		'ntfnetmount' : 'Mounting network volume', // added 18.04.2013
			...
			'degree'          : '°',
			'netMountDialogTitle' : 'Mount network volume', // added 18.04.2013
			'protocol'            : 'Protocol', // added 18.04.2013
			'host'                : 'Host', // added 18.04.2013
			'port'                : 'Port', // added 18.04.2013
			'user'                : 'User', // added 18.04.2013
			'pass'                : 'Password', // added 18.04.2013
